...
ALTER TABLE ITEM MODIFY COLUMN cod_midia SMALLINT DEFAULT 0;
ALTER TABLE ITEM MODIFY COLUMN cod_livro SMALLINT DEFAULT 0;
ALTER TABLE ITEM MODIFY COLUMN cod_instrumento SMALLINT DEFAULT 0;
ALTER TABLE ITEM MODIFY COLUMN cod_acessorio SMALLINT DEFAULT 0;
